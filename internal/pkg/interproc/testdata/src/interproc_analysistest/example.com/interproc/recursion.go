...
import (
	"interproc_analysistest/example.com/core"
)
...
func IsEven(i string) bool { // want IsEven:"genericFunc{ sinks: <>, taints: <<0>> }"
	return !IsOdd(i)
}

func IsOdd(i string) bool { // want IsOdd:"genericFunc{ sinks: <>, taints: <<0>> }"
	return !IsEven(i)
}
